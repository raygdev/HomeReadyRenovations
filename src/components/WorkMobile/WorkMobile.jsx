    ...
    return(
        <section className='--work-section-container mobile'>       
          <div className='--work-commerical-container --work-portfolio'>
            ...
            <Link to='/portfolio' className='--work-commercial-link center'>View More</Link>
          </div>
          <div className='--work-interior-container --work-portfolio'>
            ...
            <Link to='/portfolio' className='--work-interior-link center'>View More</Link>
          </div>
          <div className='--work-exterior-container --work-portfolio'>
            ...
            <Link to='/portfolio' className='--work-exterior-link center'>View More</Link>
          </div>
        </section>
    )
}
