  ...
  return (
    <header className="--header-elem">
      <div className="--header-sticky-container flex flex-align-center">
        <div
          className="--header-logo-container mobile"
      ...
      {!navCollapsed && (
        <nav id="--header-nav" className="--header-nav flex">
          <ul className="--header-nav-ul flex">
            <HashLink to="/#Home" className="link mobile">
              <li>Home</li>
            </HashLink>
            <HashLink to="/#AboutUs" className="link mobile">
              <li>AboutUs</li>
            </HashLink>
            <HashLink to="/#OurWork" className="link mobile">
              <li>Our Work</li>
            </HashLink>
            <HashLink to="/#Feedback" className="link mobile">
              <li>Feedback</li>
            </HashLink>
          </ul>
        </nav>
