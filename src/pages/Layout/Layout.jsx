...
export const Layout = ()=> {
  ...
  return(
    <>
      ...
      <aside className='--layout-aside-container'>
        <div className='--layout-aside-content-container flex flex-column'>
          <h2 className='--layout-current-nav'>Home</h2>
          <div className='--layout-aside-social-container'>
            <ul className='--layout-aside-social-list flex flex-column flex-center flex-align-center'>
              <Link><li><img src={fbIcon} alt="" /></li></Link>
              <Link><li><img src={instaIcon} alt="" /></li></Link>
              <Link><li><img src={tiktokIcon} alt="" /></li></Link>
              <Link><li><img src={youtubeIcon} alt="" /></li></Link>
            </ul>
          </div>
        </div>
